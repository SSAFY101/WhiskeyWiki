...
('모히또', 'Mojito', '하이볼 글라스에 민트 몇 가지와 설탕 2tsp를 넣는다. 라임 주스 20ml를 넣고 민트잎과 섞어준다. 잔에 으깬 얼음을 넣고 하바나 클럽을 45ml를 붓고 탄산수를 50ml 붓는다. 슬라이스 된 라임 조각과 민트잎으로 장식한다', '민트의 상쾌한 향과 라임의 신선한 맛이 어우러져 특별한 맛을 내는 칵테일입니다.'), -- 하바나 클럽 / 민트 잎, 라임
('다이키리', 'DaiQuiri', '얼음과 하바나 클럽 60ml와 라임 주스 20ml과 설탕 2tsp을 쉐이커에 넣어 쉐이킹 한뒤 잔에 넣어 마십니다.', '헤밍웨이가 사랑한 2가지의 칵테일로 뽑히는 유명한 칵테일입니다, 만들기에는 간단하지만 럼의 맛과 달달하고 상큼한 라임의 맛이 어우러지는 대표적인 칵테일입니다'), --하바나 클럽 / 라임주스
...
values ('레몬'), ('레몬즙'), ('라임'), ('라임즙'), ('민트 잎'),('시나몬 스틱'),('크렌베리 주스'),('그레나딘 시럽'),('에너지 드링크');
